"""Taint function-model database: load, validate, lookup, overlay disclosure.

Split out of ``taint_engine`` so the fixpoint engine file stays focused on
propagation. Import-free of Binary Ninja (and of the engine).
"""
